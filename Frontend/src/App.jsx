  ...
  const runBattle = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        const judgeName = JUDGES_LIST.find(j => j.id === judgeModel)?.name || judgeModel;
    ...
    <div className="app-container" onMouseMove={handleMouseMove} onMouseUp={handleMouseUp}>
      ...
      <aside className="left-panel">
        ...
        <div className="panel-content">
          ...
          <div className="draggable-items">
            <div className="drag-item logic-item">
              <div className="drag-item-left">
                <span className="drag-item-icon">⚡</span>
                <span>Condition</span>
              </div>
              <span className="drag-item-plus">+</span>
            </div>
          </div>
        </div>
      </aside>
        ...
        <div className="workspace-topbar">
          <div className="topbar-left">
            ...
            <div className="form-title-container">
              ...
              <span className="status-badge" style={{color: '#a78bfa'}}>unsaved</span>
            </div>
          </div>
          <div className="topbar-actions">
            ...
            <div className="topbar-tabs">
              <div className="topbar-tab active">Inspector</div>
            </div>
          </div>
        </div>
